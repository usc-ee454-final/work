...
module CONNECT_testbench_sample();
  ...
  layer mult1(Clk, ~Rst_n, mult1_recv_flit, mult1_flit_in, 2, mult1_send_flit, mult1_flit_out);
  layer mult2(Clk, ~Rst_n, mult2_recv_flit, mult2_flit_in, 3, mult2_send_flit, mult2_flit_out);
